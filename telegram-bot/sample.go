...
func Handler(res http.ResponseWriter, req *http.Request) {
	...
	log.Println("body text: ",body.Message.Text," user id: ",body.Message.Chat.ID)
...
func sayPolo(chatID int64) error {
	...
	res, err := http.Post("https://api.telegram.org/bot1619145503:AAFKpUbGqVtkIGXzjNc00sl_JaqTGuqsHRc/sendMessage", "application/json", bytes.NewBuffer(reqBytes))
	if err != nil {
		return err
	}
...
func main() {
	...
	//curl -F "url=https://f42441533d93.ngrok.io /"  "https://api.telegram.org/bot1619145503:AAFKpUbGqVtkIGXzjNc00sl_JaqTGuqsHRc/setWebhook"
}